...
![Work From Home Pie Chart](sql_queries\assets\work_from_home_pie_chart.png)
...
![No Degree Pie Chart](sql_queries\assets\no_degree_pie_chart.png)
...
![Top paying jobs skills](sql_queries\assets\most_sought_after_skills.png)
...
![Top paying jobs skills](sql_queries\assets\number_of_jobs_by_skill.png)
...
![Top 10 Paying Data Analyst Jobs](sql_queries\assets\top_10_paying_data_analyst_jobs.png)
...
![Job demands skills for Data Analyst](sql_queries\assets\job_demand_for_skills.png)
...
ORDER BY
    avg_salary DESC;
```
![Salary comparison chart](sql_queries\assets\salary_comparison_chart.png)
...
![Degree requirement and and average salary ](sql_queries\assets\degree_salary_job_count_chart_better_colors.png)